package com.example.unitedpoultry.AdminExpense
...
class AdminExpenseActivity : BaseActivity() {

    private lateinit var binding: ActivityAdminExpenseBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAdminExpenseBinding.inflate(layoutInflater)
