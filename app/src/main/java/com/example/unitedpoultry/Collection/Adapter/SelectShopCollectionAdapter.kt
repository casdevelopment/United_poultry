package com.example.unitedpoultry.Collection.Adapter
...
class SelectShopCollectionAdapter(
    private val list: MutableList<ShopCollectionModel>
) : RecyclerView.Adapter<SelectShopCollectionAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_collection_selectshop, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvDue.text = "Rs. ${item.due.toString()}"
        ...
        holder.itemView.setOnClickListener {
            ...
            intent.putExtra("balance", item.due.toString())
    ...
    class ViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        val tvDue: TextView = v.findViewById(R.id.tvDue)
    }
