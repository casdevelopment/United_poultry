package com.example.unitedpoultry.AdminHome.Adapter
...
class ShopVisitedAdapter(
    private val list: MutableList<ShopvisitedModel>
) : RecyclerView.Adapter<ShopVisitedAdapter.ViewHolder>() {

    private val originalList = ArrayList(list)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_visited_shop, parent, false)
