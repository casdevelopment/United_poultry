...
class AdminLogoutViewModel(private val repository: Repository) : ViewModel() {

    fun adminLogout(): LiveData<NetworkStates<Response<BaseResponse<Any>>>> {
        return liveData(Dispatchers.IO) {
            emit(NetworkStates.loading(null))
            try {
                val response: Response<BaseResponse<Any>> = repository.adminLogout()
