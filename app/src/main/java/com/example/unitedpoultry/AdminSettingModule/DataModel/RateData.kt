...
data class RatesData(
    ...
    val product_id: Int?,           // Changed from String to Int?
    val product_name: String?,      // Made Nullable
    val packing: String?,           // Made Nullable
    val eggs_count: Int?,           // Changed from String to Int?
    val price: String?,             // String (or Double)
    val date: String? = null
)
